...
<Tip>
- Use “Equity Shares (Number)” for numeric equity values
- “Base Salary Override” will replace the salary sent by Ashby
</Tip>
...
<Card title="Import equity details" icon="circle-stack">
