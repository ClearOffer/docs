...
<CardGroup cols={2}>
<Card title="Who should use this" icon="user">
Workspace admins in ClearOffer and Ashby admins who can create API keys.
</Card>
...
<CodeGroup>
```text Offer basics
Approved Ashby offers are created/updated in ClearOffer.
```
...
```text Compensation
Base salary, currency, start date, and job title.
```

```text Custom mappings
Anything you map via Custom Field Mapping (below).
```
</CodeGroup>
